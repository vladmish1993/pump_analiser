...
class SnapshotWorker:
    ...
    async def _build_snapshot(self, token_address: str, checkpoint: str) -> TokenSnapshot:
        ...
        return TokenSnapshot(
            ...
            bluechip_owner_count    = stat.get("bluechip_owner_count"),
            bot_rate_pct            = stat.get("bot_rate_pct"),
            top_bot_degen_pct       = stat.get("top_bot_degen_pct"),
            ...
            private_vault_hold_rate = stat.get("private_vault_hold_rate"),
